...
# minimum and maxium times aka start and end times   ***** MAKE THE LENGTH OF THE EXPERIMENT A VARIABLE ******
...
def tpc_mean_plot(num_samp_roll=4):
    ...
    if num_samp_roll == 1:
        ...
        plt.title(f'Mean Total Particle Concentration({num_samp_roll} samples)')
